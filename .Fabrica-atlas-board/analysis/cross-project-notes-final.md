# Cross-Project Feed Notes - FINAL CONSOLIDATED (Rounds 4-5)

> **Purpose:** single relay-ready file for the Fabrica-app board. Merges v2 (FA-N1..N10, Round 4 waves 4-7) + v3 (FA-N11..N17, Round 4/5 final reports). All notes citation-backed with verification status. FA-N15 item 9 corrected per F-1 evidence (generateId is collision-proof nanoid, not Date.now).

> **How to use:** each note is self-contained; paste individually into target project boards. Notes are numbered globally for reference.
...
*Consolidated by ATLAS orchestrator from cross-project-notes-r4.md + cross-project-notes-r5.md. Source files preserved unchanged.*
